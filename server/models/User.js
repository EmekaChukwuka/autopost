...
class User {
  ...
  static async findById(id) {
    return await UserModel.findById(id, "id name email avatar provider verified subscription_plan_id subscription_start_date subscription_status subscription_end_date socialAccounts").lean();
  }
...
static async findLinkedInUsers() {
